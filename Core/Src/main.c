...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, USB_FS_PWR_EN_Pin|GPIO_PIN_15|GPIO_PIN_2|GPIO_PIN_3
  ...
  /*Configure GPIO pins : USB_FS_PWR_EN_Pin PD15 PD2 PD3
                           PD6 PD7 */
  GPIO_InitStruct.Pin = USB_FS_PWR_EN_Pin|GPIO_PIN_15|GPIO_PIN_2|GPIO_PIN_3
